 ...
 */
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        Person1 p1 = new Person1("Ethan Wang");
        toPrint += p1.toString("ewang78");
        //Person2 replace P2 with your name
        //and gburdell with your gt id
        Person2 p2 = new Person2("Gunhyun Park");
        toPrint += p2.toString("gpark77");
        //Person3 replace P3 with your name
        //and gburdell3 with your gt id
        Person3 p3 = new Person3("Keun Tae Park");
        toPrint += p3.toString("kpark349");
        //Person4 replace P4 with your name
        //and gburdell4 with your gt id
        Person4 p4 = new Person4("Neil Thistlethwaite");
        toPrint += p4.toString("ndt3");
        //Person5 replace P4 with your name
        //and gburdell5 with your gt id
        Person5 p5 = new Person5("Jerry Huang");
        toPrint += p5.toString("jhuang437");
